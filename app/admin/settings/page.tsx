...
import { LayoutDashboard, Shield, Layers, Users } from "lucide-react"
        ...
        <div className="space-y-6">
          ...
          <Card className="hover:shadow-sm transition-shadow">
            <CardHeader>
              ...
              <CardDescription>Control whether others see you as online</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between rounded-lg border p-3">
                <div>
                  <div className="font-medium">Show as Online</div>
                  <div className="text-sm text-muted-foreground">When on, your presence is visible across the app</div>
                </div>
